...
namespace OzgurSeyhanWebSitesi.Repository.Migrations
{
    ...
    [Migration("20260505114047_ExpandOzelDersKurSeviyesi")]
    partial class ExpandOzelDersKurSeviyesi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OzgurSeyhanWebSitesi.Core.Models.FlowPuzzleLongPhrase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ContextPhraseEn")
                        .IsRequired()
                        .HasMaxLength(300)
                    ...
                    b.Property<string>("DetailPhraseEn")
                        .IsRequired()
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)");
                    ...
                    b.Property<string>("FullPhraseEn")
                        .IsRequired()
                        .HasMaxLength(900)
                        .HasColumnType("nvarchar(900)");

                    b.Property<string>("HeadNounEn")
                        .IsRequired()
                        .HasMaxLength(200)
                    ...
                    b.ToTable("FlowPuzzleLongPhrases", (string)null);
                });

            modelBuilder.Entity("OzgurSeyhanWebSitesi.Core.Models.FlowPuzzleNoun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FlowPuzzleNouns");
                });

            modelBuilder.Entity("OzgurSeyhanWebSitesi.Core.Models.FlowPuzzleRelativeClause", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RelativeClauseEn")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("RelativeClauseTr")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("SourcePairEn")
                        .IsRequired()
                        .HasMaxLength(800)
                        .HasColumnType("nvarchar(800)");

                    b.Property<string>("SourcePairTr")
                        .HasMaxLength(800)
                        .HasColumnType("nvarchar(800)");
                    ...
                    b.ToTable("FlowPuzzleRelativeClauses", (string)null);
                });

            modelBuilder.Entity("OzgurSeyhanWebSitesi.Core.Models.FlowPuzzleSentence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DeterminerPlural")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<string>("DeterminerSingular")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<string>("TurkishPlural")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("TurkishSingular")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.ToTable("FlowPuzzleSentences", (string)null);
                });

            modelBuilder.Entity("OzgurSeyhanWebSitesi.Core.Models.Hakkimda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OzgurSeyhanWebSitesi.Core.Models.ReferansLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OzgurSeyhanWebSitesi.Core.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("EmailDogrulamaTarihi")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("EmailDogrulamaTokenExpiry")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("EmailDogrulamaToken")
            ...
            modelBuilder.Entity("OzgurSeyhanWebSitesi.Core.Models.FlowPuzzleSentence", b =>
                {
                    b.HasOne("OzgurSeyhanWebSitesi.Core.Models.FlowPuzzleNoun", "Noun")
                        .WithMany()
